        ...
        <template v-if="!store.isProfileSet">
          <div class="relative py-2">
            ...
            <div class="relative flex justify-center text-xs font-bold uppercase tracking-widest">
              <span class="bg-gray-50 px-4 text-gray-400 dark:bg-gray-950">OR</span>
            </div>
          </div>
          ...
          <p class="text-center text-[11px] font-bold text-gray-400 dark:text-gray-600">
            {{ $t("login.anonymousSubtitle") }}
          </p>
        </template>
